...
{
    /// <summary>
    /// A class that finds types needed by Aaron by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>Gets or sets wether Aaron should iterate assemblies in the app domain when loading Aaron types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that Aaron assemblies arn't investigated (e.g. by not including something like "^Aaron|..." you may break core functionality.</remarks>
        ...
        /// <returns>A list of assemblies that should be loaded by the Aaron factory.</returns>
        ...
        /// <returns>True if the assembly should be loaded into Aaron.</returns>
